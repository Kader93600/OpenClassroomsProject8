  ...
  const projects = [
    {
      ...
      imageUrl: booki,
      projectUrl: 'http://lien-vers-projet1.com',
      competence:"✅Installer un environnement de développement front-end ✅Intégrer du contenu conformément à une maquette avec HTML & CSS ✅Implémenter une interface responsive avec HTML & CSS ✅Versionner son projet avec Git et Github"
    },
    {
      title: "Sophie Bluel",
      ...
      imageUrl: sophie,
      projectUrl: 'http://lien-vers-projet1.com',
      competence:"✅Manipuler les éléments du DOM avec JavaScript ✅ Gérer les évènements utilisateurs avec JavaScript ✅ Récupérer les données utilisateurs via des formulaires"
    },
    {
      title: 'Nina Carducci',
      ...
      imageUrl: nina,
      projectUrl: 'http://lien-vers-projet1.com',
      competence:"✅Optimiser les performances, le référencement et l'accessibilité d'un site web ✅Débugger un site web grâce aux Chrome DevTools ✅Rédiger un cahier de recette pour tester un site"
    },
    {
      title: 'Kasa',
      ...
      imageUrl: kasa,
      projectUrl: 'http://lien-vers-projet1.com',
      competence:"✅Développer des éléments de l'interface d'un site web grâce à des composants React ✅Initialiser une application avec Create React App ✅Configurer la navigation entre les pages de l'application avec React Router"
    },
    {
      ...
      projectUrl: 'http://lien-vers-projet1.com',
      competence:"✅ Implémenter un modèle logique de données conformément à la réglementation ✅ Mettre en œuvre des opérations CRUD de manière sécurisée ✅ Stocker des données de manière sécurisée "
    },
